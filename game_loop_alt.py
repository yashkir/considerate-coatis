...
class game:
    ...
    def render_game_screen(self) -> None:
        ...
        box = urwid.LineBox(pile, title="Game")

        self.game_screen_loop = urwid.MainLoop(box, unhandled_input=self.handle_input)
        self.loops.append(self.game_screen_loop)

        self.game_screen_loop.run()
